...
exports.libParse = void 0;
var ts = require("typescript");
var fs_1 = require("fs");
var path = require("path");
var LIBRARY_NAME = '@testlio/panthera';
var ALLOWED_FILE_TYPES = 'tsx, jsx, ts, js';
var RESULT_FILE_NAME = 'example.json';
var FILE_EXTENSION_PATTERN = new RegExp(".[" + ALLOWED_FILE_TYPES.split(',').map(function (el) { return "(" + el.trim() + ")"; }).join("|") + "]+$", 'i');
